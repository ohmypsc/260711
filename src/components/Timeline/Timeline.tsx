...
const captions: Caption[] = [
  { imgIndex: 1, title: <span className="no-break">1989년 가을,</span> },
  { imgIndex: 2, title: <span className="no-break">1990년 봄,</span> },
  { imgIndex: 3, title: <span className="no-break">2024년 가을,</span> },
